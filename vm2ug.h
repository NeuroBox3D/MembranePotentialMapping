...
template <class T> class Vm2uG {
   ...
   public:
      ...
      */
      ...
      @param cutoff maximum distance for nearest neighbor
      @param k how many nearest neighbors should be considered for linear interpolation

      @return membrane potential (potentially linearly interpolated)
       */
     ...
     /** interpolate bilinearly
         ...
         @param timestep for which the nearest neighbor should be computed
         @param cutoff maximum distance for nearest neighbor
         @param k how many nearest neighbors should be considered for bilinear interpolation

         @return membrane potential (potentially bilinearly interpolated)
     */
